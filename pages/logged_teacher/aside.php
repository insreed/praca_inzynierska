    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                <!-- Dashboard -->
                <li class="nav-item">
                    <a class="nav-link <?php echo (!isset($_GET['subjectId']) && !isset($_GET['view']) || (isset($_GET['view']) && $_GET['view'] == 'dashboard')) ? 'active' : ''; ?>" href="?view=dashboard">
                ...
                if ($result->num_rows > 0) {
                    while ($subject = $result->fetch_assoc()) {
                        ...
                        echo "<li class='nav-item'>
                                <a href='./logged.php?subjectId={$subject['id_przedmiotu']}' class='nav-link $isActive'>
